...
setup(
    ...
    url= 'https://github.com/matek-alphacruncher/nuvolos_collect',
    download_url=(
        f'https://github.com/matek-alphacruncher/'
        f'nuvolos_collect/archive/{version}.tar.gz'
    ),
    keywords=[
